...
-- CreateEnum
CREATE TYPE "TrasanctionTimeStatus" AS ENUM ('PENDING', 'COMPLETED', 'FAILED');
...
CREATE TABLE "transactions" (
    ...
    "receiptUrl" TEXT,
    "inRecurring" BOOLEAN NOT NULL DEFAULT false,
    "recurringInterval" "RecurringInterval",
    "nextRecurringData" TIMESTAMP(3),
    "lastProcessed" TIMESTAMP(3),
    "status" "TrasanctionTimeStatus" NOT NULL DEFAULT 'COMPLETED',
    "userId" TEXT NOT NULL,
