...
const AddTransactionForm = ({accounts,categories, editMode=false,initialData=null}) => {
  ...
  useEffect(()=>{
    if(transactionResult?.success && !transactionLoading){
      ...
      console.log("accountId",transactionResult.data.accountId)
      reset();
      ...
      >
        ...
        <SelectContent>
          ...
          <CreateAccountDrawer>
            <Button
              variant="ghost"
              className="relative mt-1 flex w-full cursor-pointer items-center rounded-sm py-1.5 pl-8 pr-2 text-sm hover:bg-accent hover:text-accent-foreground"
            >
              Create Account
            </Button>
          </CreateAccountDrawer>
