...
// Fix: Handles both single and array transaction serialization
const serializeAmount = (obj) => {
  if (Array.isArray(obj)) {
    return obj.map((item) => ({ ...item, amount: item.amount?.toNumber() }));
  }
...
export async function createTransaction(data) {
  try {
    ...
    // Fix: Safely convert balance to number
    ...
    // Fix: `transaction` is awaited above, not a Promise
...
// Helper function for recurring logic
